...
export default class ModelViewerElementBase extends UpdatingElement {
    ...
    get [(_a = $loaded, _b = $lastDpr, _c = $clearModelTimeout, _d = $fallbackResizeHandler, _e = $resizeObserver, _f = $intersectionObserver, _g = $progressTracker, $renderer)]() {
        return renderer;
    }
    get modelIsVisible() {
        return true;
